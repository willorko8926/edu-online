  ...
  <div class="col-md-12">
    <div class="panel panel-default">
      <div class="panel-heading clearfix">
        <strong>
          ...
          <span>CATEGORIA POR MATERIA</span>
       </strong>
         <a href="../index.php" class="btn btn-danger pull-right">ATRAS</a> 
         <a href="insertar.php" class="btn btn-info">AGREGAR CATEGORIA</a>
      </div>
    ...
    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="80%">
        ...
        <?php
            ...
            foreach($cole->showCategorias() as $datos)
            {
                ?>

           <tr>
           
        <td class=""><?php echo "".$datos->getIdCategoria(); ?></td>
         <td class=""><?php echo "".$datos->getNombre(); ?></td>
        <td><a class="link" href="editar.php?id=<?php echo $datos->getIdCategoria(); ?>">Editar</a></td>
        <td><a class="link" href="eliminar.php?id=<?php echo $datos->getIdCategoria(); ?>">Eliminar</a></td><br>
        </tr>
