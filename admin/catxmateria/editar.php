                ...
                <div class="container-fluid">
                    ...
                    <form action="actualizar.php" method="post">
                       ...
                       <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="idcategoria" name="idcategoria" value="<?php echo $ObjCategoria->getIdCategoria(); ?>" placeholder="Id Categoria" rows="6" readonly>
                        </div>
                        <div class="form-group">
                            <label for="nombre">Nombre</label>
                            <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo $ObjCategoria->getNombre(); ?>" placeholder="nombre" rows="6">
                        </div>
