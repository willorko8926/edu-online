                ...
                <div class="container-fluid">
                    ...
                    <form action="guardar.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nombreusuario" name="nombreusuario" placeholder="Nombre" rows="6">
                        </div>
                        <div class="form-group">
                            <label for="contrasenia">Contrasenia</label>
                            <input type="text"class='form-control' id="contrasenia" name="contrasenia" placeholder="Contrasenia" rows="6">
                        </div>
                        <div class="form-group">
                            <label for="perfil">Perfil</label>
                            <input type="text"class='form-control' id="perfil" name="perfil" placeholder="Perfil" rows="6">
                        </div>
                        <div class="form-group">
                            <label for="persona_id">Persona Id</label>
                            <input type="text"class='form-control' id="persona_id" name="persona_id" placeholder="Persona Id" rows="6">
                        </div>
