  ...
  <div class="col-md-12">
    <div class="panel panel-default">
      <div class="panel-heading clearfix">
        <strong>
         ...
         <a href="insertar.php" class="btn btn-info">AGREGAR CONTENIDO</a>
      </div>
    ...
    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="80%">
        ...
        <?php
            ...
            include_once $_SERVER['DOCUMENT_ROOT'].'/ProyectoPhp-Grupo8/admin/contenido/Contenido.php';
            include_once $_SERVER['DOCUMENT_ROOT'].'/ProyectoPhp-Grupo8/admin/contenido/ContenidoCollector.php';
        ...
        <td><a class="link" href="editar.php?id=<?php echo $datos->getIdContenido(); ?>">Editar</a></td>
        <td><a class="link" href="eliminar.php?id=<?php echo $datos->getIdContenido(); ?>">Eliminar</a></td><br>
        </tr>
