  ...
  <div class="col-md-12">
    <div class="panel panel-default">
      <div class="panel-heading clearfix">
        <strong>
         ...
         <a href="insertar.php" class="btn btn-info">AGREGAR MATERIA</a>
      </div>
    ...
    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="80%">
        ...
        <?php
            ...
            include_once $_SERVER['DOCUMENT_ROOT'].'/ProyectoPhp-Grupo8/admin/materia/Materia.php';
            include_once $_SERVER['DOCUMENT_ROOT'].'/ProyectoPhp-Grupo8/admin/materia/MateriaCollector.php';

            $cole= new MateriaCollector();


            foreach($cole->showMaterias() as $datos)
            {
                ?>

           <tr>
        <td class=""><?php echo "".$datos->getIdMateria(); ?></td>
         <td class=""><?php echo "".$datos->getNombre(); ?></td>
         <td class=""><?php echo "".$datos->getAyudante_id(); ?></td>
         <td class=""><?php echo "".$datos->getAlumno_id(); ?></td>
         <td class=""><?php echo "".$datos->getCategoria_id(); ?></td>

        <td><a class="link" href="editar.php?id=<?php echo $datos->getIdMateria(); ?>">Editar</a></td>
        <td><a class="link" href="eliminar.php?id=<?php echo $datos->getIdMateria(); ?>">Eliminar</a></td><br>
        </tr>
